      ...
      <div className="max-w-5xl mx-auto px-4 py-8 md:py-12">
        ...
        {!cartItems || cartItems.length === 0 ? (
          <div className="bg-white rounded-3xl p-16 text-center border border-dashed">
            ...
            <Link href="/" className="inline-block mt-6 bg-red-600 text-white px-8 py-3 rounded-full font-bold">
              কেনাকাটা শুরু করুন
            </Link>
          </div>
        ) : (
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3 flex items-center gap-4">
                       <div className="flex items-center bg-gray-100 rounded-xl p-1 px-3 gap-4">
                          ...
                          <form action={async () => {
                              'use server'
                              await updateDbCartQuantity(item.id, item.quantity - 1)
                          }}>
                       ...
                       <form action={async () => {
                           'use server'
                           await removeFromDbCart(item.id)
                       }}>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-xl border h-fit sticky top-24">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="border-t pt-4 flex justify-between text-red-600">
                    ...
                    <span className="text-3xl font-black">৳{subtotal}</span>
                </div>
              </div>
